...
export default function PrizeInfoDialog({ prizes }: PrizeInfoDialogProps) {
  return (
    <Dialog>
      ...
      <DialogContent className="fixed top-1/2 left-1/2 z-50 max-h-[80vh] w-full max-w-lg bg-white rounded-xl p-6 shadow-lg -translate-x-1/2 -translate-y-1/2 overflow-y-auto">
